                                    ...
                                    <div class="p-3">
                                        <form class="form-horizontal mb-0" action="index.html">
                                            ...
                                            <div class="alert alert-danger mt-3 alert-dismissible">
                                                ...
                                                Ingresa tu <b>Correo Electronico</b> el administrador se pondra en contacto contigo mediante tu correo!
                                            </div>
                                            ...
                                            <div class="form-group text-center row m-t-20 mb-0">
                                                <div class="col-12">
                                                    <button class="btn btn-raised btn-success btn-block waves-effect waves-light" type="submit">Enviar Correo</button>
                                                </div>
                                            </div>
